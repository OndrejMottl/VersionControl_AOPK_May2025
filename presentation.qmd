...
::: {.text-center}
🕵️Version Control (as a methodology)?
:::
...
😸Code on GitHub: [OndrejMottl/VersionControl_AOPK_May2025](https://github.com/OndrejMottl/VersionControl_AOPK_May2025)

![](https://img.shields.io/badge/License-MIT-yellow.svg)

🖼️Slides: [bit.ly/mottl_prez_20250514](https://bit.ly/mottl_prez_20250514)
...
::: {.text-center}
It is all about [keeping track]{.text-background-dartmouth-green} of [changes]{.text-background-brunswick-green} 📓✍️
:::
...
Github allows you to specify [roles]{.text-background-dartmouth-green} and [permissions]{.text-background-brunswick-green} of your repo.
...
# [Task management]{.bold .r-fit-text .text-color-white} {.bg-dartmouth-green}

## Issue (a task) on GitHub

Original purpose of [GitHub Issues]{.text-background-dartmouth-green} is to track bugs & feature requests in software developmen projects🧑‍💻.
...
You can split tasks into [subtasks]{.text-background-dartmouth-green} and [checklists]{.text-background-brunswick-green}.
...
You can use [labels]{.text-background-dartmouth-green} to categorize tasks.
...
* [priority]{.text-background-dartmouth-green}
* [type]{.text-background-brunswick-green}
* [status]{.text-background-orange-web}
* ...
:::
...
[Issues]{.text-background-dartmouth-green} can be linked to [Pull Requests]{.text-background-brunswick-green}.
...
# [Outro]{.bold .r-fit-text .text-color-white} {.bg-dartmouth-green}
